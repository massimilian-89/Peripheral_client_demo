...
static const struct advertise_configuration user_adv_conf = {
    ...
    .intv_min = MS_TO_BLESLOTS(200),                    // 687.5ms

    /// Maximum interval for advertising
    .intv_max = MS_TO_BLESLOTS(200),                    // 687.5ms
 ...
 */
/// Device name
#define USER_DEVICE_NAME        "GAP_periph_GATT_Client"
...
#define dbg_block_printf(fmt, args...){\
									 arch_printf(fmt, args);		\
									 arch_printf_process();			\
								 }
								 
//#define dbg_printf(fmt, args...) { arch_printf(fmt, args); }
